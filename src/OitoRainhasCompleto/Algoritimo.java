package OitoRainhasCompleto;

import OitoRainhasCompleto.Individuo;
import OitoRainhasCompleto.Populacao;
import OitoRainhasCompleto.MainFrame;
...
public class Algoritimo {
    ...
    public static void AG(MainFrame frame) {
    ...
    private static class ExecutaAG implements Runnable {
        ...
        public ExecutaAG(MainFrame frame) {
            this.frame = frame;
        }
        ...
        public void run() {
            ...
            frame.setLog("Geracao " + geracao + ":\n"
                    ...
                    + "Media: " + populacao.getMediaAptidao() + "\n"
